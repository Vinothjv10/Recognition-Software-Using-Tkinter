...
class Student:
    ...
    # Student name
        ...
        studentName_entry = ttk.Entry(class_Studdent_frame,
                                      width=20, font=("times new roman", 13, "bold"))
    ...
    # Class Division
        ...
        clas_div_entry = ttk.Entry(class_Studdent_frame,
                                   width=20, font=("times new roman", 13, "bold"))
    ...
    # Roll No
        ...
        roll_no_entry = ttk.Entry(class_Studdent_frame,
                                  width=20, font=("times new roman", 13, "bold"))
    ...
    # Gender
        ...
        gender_entry = ttk.Entry(class_Studdent_frame,
                                 width=20, font=("times new roman", 13, "bold"))
    ...
    # DOb
        ...
        dob_entry = ttk.Entry(class_Studdent_frame,
                              width=20, font=("times new roman", 13, "bold"))
    ...
    # Email
        ...
        email_entry = ttk.Entry(class_Studdent_frame,
                                width=20, font=("times new roman", 13, "bold"))
    ...
    # Phone no
        ...
        phone_entry = ttk.Entry(class_Studdent_frame,
                                width=20, font=("times new roman", 13, "bold"))
    ...
    # Address
        ...
        address_entry = ttk.Entry(class_Studdent_frame,
                                  width=20, font=("times new roman", 13, "bold"))
    ...
    # Teacher Name
        ...
        teacher_entry = ttk.Entry(class_Studdent_frame,
                                  width=20, font=("times new roman", 13, "bold"))
        teacher_entry.grid(row=4, column=3, padx=10, pady=5, sticky=W)
    # Raio Buttons
        radiobtn1 = ttk.Radiobutton(
            class_Studdent_frame, text="Take Photo Sample", value="Yes")
        radiobtn1.grid(row=6, column=0)

        radiobtn2 = ttk.Radiobutton(
            class_Studdent_frame, text="No Photo Sample", value="Yes")
     ...
     # BButtons Frame
        ...
        save_btn = Button(btn_frame, text="Save", width=17,
        ...
        delete_btn = Button(btn_frame, text="Delete", width=17,
                            font=("times new roman", 13, "bold"), bg="blue", fg="white")
